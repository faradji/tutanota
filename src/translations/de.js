export default {
	...
	"updated_at": "2021-01-20T13:47:00Z",
	"source_locale": {
	...
	"keys": {
		...
		"accountSwitchAliases_msg": "Bitte lösche alle Aliasse deines Benutzers.",
		"accountSwitchCustomMailAddress_msg": "Bitte deaktiviere alle E-Mail Aliasse mit eigener Domain.",
		"accountSwitchFeature_msg": "Bitte deaktiviere die Funktion {featureName}.",
		"accountSwitchMultipleCalendars_msg": "Bitte lösche alle zusätzlichen Kalender.",
		"accountSwitchNotPossible_msg": "Du musst alle bezahlten Funktionen deaktivieren, bevor du zu einem kostenfreien Account wechseln kannst. {detailMsg}",
		...
		"addCustomDomainAdresses_msg": "Die Domain wurde für dein Konto registriert. Um sie benutzen zu können, füge deinem aktuellen Benutzer bitte mindestens einen Alias hinzu. Alternativ kannst du neue Benutzer für die Domain anlegen.",
		"addCustomDomainAliases_msg": "Füge dem aktuellen Postfach einen E-Mail-Alias hinzu, wenn du eine weitere E-Mail-Adresse für dich selbst benötigst.",
		"addCustomDomainUsers_msg": "Erstelle neue Benutzer oder neue E-Mail-Aliasse für bestehende Benutzer, wenn du E-Mail-Adressen für andere Personen benötigst.",
		...
		"addUsers_title": "Benuzer hinzufügen?",
		...
		"all_label": "Alle",
		"alreadyMember_msg": "Du bist bereits Teilnehmer des Kalenders. Wenn du diese Einladung akzeptieren möchtest, musst du zuvor deine Teilnahme beenden.",
		...
		"bookingItemUsersIncluding_label": "Benutzer inkl:",
		...
		"certificateRenewalFailureBody_msg": "Das Zertifikat für deine Domain {1} muss erneuert werden, aber wir konnten die Erneuerung nicht durchführen, da die CNAME-Einträge im DNS nicht korrekt auf unsere Server verweisen.\n\nBitte rufe deine Einstellung auf um weitere Informationen zu bekommen und richte die korrekten Weiterleitungen schnellstmöglich ein. Diese Nachricht erhältst du täglich.",
		...
		"deletionWarning_msg": "Aus Datenschutzgründen werden kostenlose Konten gelöscht, wenn sie länger als sechs Monate nicht benutzt werden. Konten von zahlenden Benutzern werden nicht gelöscht. Lies hier, welche Vorteile du mit unseren bezahlten Abonnements bekommst:\n\n",
		...
		"downgradeToPremium_msg": "Der Account wird zu einem Premium-Account mit 5 Alias-Adressen und 1 GB Speicher, ohne die Freigeben-Funktion und Whitelabel-Optionen gewechselt.",
		...
		"enforceAliasSetup_msg": "Bevor du fortfährst, musst du einen E-Mail-Alias oder einen Benutzer für deine Domain anlegen.",
		...
		"eventCopy_msg": "Der Termin wurde von einem anderen Kalender versendet. Änderungen des Termins sind nur in deinem Kalender sichtbar.",
		...
		"firstReminderAutomatic_msg": "leider haben wir die Zahlung für deinen Tutanota-Account noch nicht erhalten. Bitte prüfe deine Zahlungsdaten in 'Einstellungen' -> 'Bezahlung'. Für weitere Rechnungsdetails kannst du dort auch alle deine Rechnungen einsehen.",
		...
		"howtoMailBody_markdown": "Tutanota ermöglicht dir verschlüsselte E-Mails an jede E-Mail-Adresse weltweit zu senden – automatisch, wenn der andere ebenfalls Tutanota nutzt, oder über ein ausgetauschtes Passwort, wenn der Empfänger einen anderen Service benutzt. Selbst unverschlüsselte E-Mails werden verschlüsselt auf unseren eigenen Servern in Deutschland gespeichert.\n\nBitte schau dir unsere FAQ, unsere Anleitung und unser Support-Forum an, um alles über deine neue sichere Mailbox zu erfahren:\n\n* [FAQ]({faqLink})\n* [Anleitung]({howtoLink})\n* [Support-Forum]({redditLink})\n\n**Suche in verschlüsselten Daten**\n\nTutanota lässt dich deine verschlüsselte Mailbox lokal auf deinem Gerät durchsuchen, um die Vertraulichkeit zu gewährleisten. Bitte klicke dazu auf das Suchfeld in der oberen Menüleiste. Die Standard-Suche geht bis einen Monat in die Vergangenheit zurück. [Um eine unlimitierte Suche sowie zahlreiche weitere Funktionen zu bekommen]({blogPremiumProLink}), nutze bitte eine bezahlte Version von Tutanota.\n\n**Direkter Support**\n\nTutanota ermöglicht jedem vertrauliche E-Mails zu senden. Mit Millionen Nutzern weltweit können wir leider nicht jede Frage per E-Mail beantworten. Wenn du die Antworten zu deinen Fragen nicht in unseren FAQ und in unserer Anleitung findest, [frage bitte die Tutanota-Community um Hilfe]({redditLink}). Direkter Support per E-Mail ist nur für zahlende Kunden verfügbar.\n\nViele Grüße,\\\ndein Tutanota-Team",
		...
		"mailAuthFailed_msg": "Diese Nachricht ist möglicherweise gefälscht. Vertraue dem Inhalt dieser Nachricht nicht, da Absenderadresse oder der Nachrichtentext gefälscht sein könnten!",
		...
		"onlyAvailableForPremiumNotIncluded_msg": "Diese Funktion kann nur nach dem Wechsel auf ein bezahltes Abonnement gebucht werden. Bitte wechsel jetzt!",
		"onlyAvailableForPremium_msg": "Diese Funktion ist nur mit einem bezahlten Abonnement verfügbar. Bitte wechsel jetzt!",
		...
		"outOfOfficeRecipientsHelp_label": "Wähle aus, wer Abwesenheitsbenachrichtigungen erhält und ob unterschiedliche Benachrichtigungen innerhalb und außerhalb deiner Organisation versendet werden.",
		...
		"outOfOfficeUnencrypted_msg": "Bitte beachte, dass Abwesenheitsbenachrichtigungen unverschlüsselt an den Server und zukünftige Empfänger gesendet werden.",
		...
		"payCardContactBankError_msg": "Die Zahlung wurde von deiner Bank abgelehnt. Bitte kontaktiere deine Bank.",
		"payCardExpiredError_msg": "Die Kreditkarte ist abgelaufen. Bitte aktualisiere deine Zahlungsdaten.",
		"payCardInsufficientFundsError_msg": "Die Zahlung wurde abgelehnt, da das Konto nicht gedeckt ist.",
		"payChangeError_msg": "Die Zahlung ist fehlgeschlagen. Eine Zahlung mit den aktuellen Zahlungsdaten ist nicht möglich. Bitte ändere deine Zahlungsdaten.",
		"payContactUsError_msg": "Die Zahlung wurde abgelehnt. Bitte kontaktiere uns.",
		...
		"payPaypalChangeSourceError_msg": "Die Zahlung ist fehlgeschlagen. Bitte wähle eine andere Zahlungsquelle in Paypal.",
		"payPaypalConfirmAgainError_msg": "Die Zahlung ist fehlgeschlagen. Bitte aktualisiere und bestätige deine Zahlungsdaten.",
		...
		"premiumOffer_msg": "Deine Unterstützung hilft uns unser Team zu vergrößern, so dass wir schneller entwickeln können. Für die geschäftliche Nutzung bist du laut unseren AGB verpflichtet zu einer kostenpflichtigen Variante zu wechseln. Lies hier, welche Vorteile du mit unseren bezahlten Abonnements bekommst:\n",
		...
		"pricing.comparisonCalendarInvites_msg": "Kalender-Einladungen",
		...
		"pushIdentifierInfoMessage_msg": "Auflistung aller Empfänger, die für diesen Tutanota-Benutzer Benachrichtigungen erhalten. Ein Eintrag kann deaktiviert werden, wenn keine Benachrichtigungen zu diesem Benutzer erwünscht sind. ",
		...
		"secondReminderAutomatic_msg": "leider haben wir die Zahlung für deinen Tutanota-Account noch immer nicht erhalten. Bitte prüfe deine Zahlungsdaten in 'Einstellungen' -> 'Bezahlung'. Für weitere Rechnungsdetails kannst du dort auch alle deine Rechnungen einsehen. Wir müssen deinen Account sperren, wenn wir die Zahlung nicht innerhalb von zwei Wochen erhalten.",
		...
		"shareCalendarWarningAliases_msg": "Außerdem erhalten sie die Möglichkeit alle E-Mail-Aliasse zu lesen, die für deine Mailbox eingerichtet sind. ",
		...
		"sharedCalendarExisting_msg": "Es sind noch Freigaben aktiv. Bitte entferne zunächst alle Freigaben.",
		...
		"sharingFeature_label": "Freigeben",
		...
		"tooManyMailsAuto_msg": "Die automatische Benachrichtigungs-E-Mail für die Einladungs-Empfänger konnte nicht gesendet werden, da die maximale Anzahl der erlaubten E-Mails überschritten wurde. Die Nachricht ist im Entwurf-Ordner gespeichert und du kannst diese Nachricht später versenden.",
		...
		"upgradePro_msg": "Dein Abonnement wird zu Pro erweitert.",
		...
		"upgradeTeams_msg": "Dein Abonnement wird zu Teams erweitert.",
